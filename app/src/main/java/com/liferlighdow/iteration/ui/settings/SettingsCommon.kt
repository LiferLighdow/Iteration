...
enum class SettingsPage {
    MAIN, HIDE_APPS, RENAME_APPS, CHANGE_ICON, APP_LIBRARY, ICON_THEME, DOCK, LIQUID_GLASS, GESTURES, SEARCH, SEARCH_ENGINE, PERMISSIONS, MANUALS, GLOBAL_SEARCH_MANUAL, ICON_ENGINE_MANUAL, DOCK_MANUAL, LANGUAGE, ADVANCED, PWA_MAKER, PWA_MANAGE, WIDGET_MAKER, WIDGET_WORKSHOP, GREENIFY, WALLPAPER
}
