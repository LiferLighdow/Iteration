...
data class LauncherSettings(
    ...
    val searchUnitConvEnabled: Boolean = true,
    val searchCurrencyConvEnabled: Boolean = true,
    val searchFilesEnabled: Boolean = true,
    val searchQuickSettingsEnabled: Boolean = true,
...
data class GestureSettings(
    ...
    val isSwipeDownSplit: Boolean = false,
    val swipeDownLeftAction: GestureAction = GestureAction.NONE,
    val swipeDownLeftApp: String = "",
    val swipeDownRightAction: GestureAction = GestureAction.NONE,
    val swipeDownRightApp: String = "",
